...
import Trofeo from '../graphics/trofeo.jpg'
       ...
       <div style={{display: 'flex', textAlign: 'center', flexDirection: 'column'}}>

          {
            this.props.location.gametype == "flags" ?
              <h2 style={{color: 'white', marginTop: '1.5em', fontWeight: 600, fontSize: '3em'}}>Identifica a que país pertenece la bandera</h2>
            :
              <h2 style={{color: 'white', marginTop: '1.5em', fontWeight: 600, fontSize: '3em'}}>Identifica a que país pertenece el lugar</h2>
          }
          ...
          <h3 style={{color: '#9C27B0', fontWeight: 600, fontSize: '2em', borderRadius: '12px',marginLeft: 'auto', marginRight: 'auto',
              ...
              <span style={{color: 'white'}}>Puntaje actual: </span>
              {this.state.score}
          </h3>
                ...
                <CardActionArea style={{marginTop: '2em', minWidth: '45em'}}>
                  ...
                  <CardContent>
                    <Typography gutterBottom variant="h5" component="h2">
                      El juego ha terminado. Tu puntaje es: {this.state.score}
                    </Typography>
           ...
           question ?
              <Card style={{margin:'0 auto'}} elevation={10}>
                <CardActionArea style={{marginTop: '2em', minWidth: '45em'}}>
                  ...
                  <CardContent>
                    <Typography gutterBottom variant="h5" component="h2">
                      Pregunta {this.state.current_question}
                    </Typography>
                    {
                      ...
                      <Typography variant="body2" color="textSecondary" component="p" style={{fontSize: '18px'}}>
                        {
                          this.state.correct_selected == true ?
                           <span style={{color: '#07d607', fontWeight: 600}}>Correcto! +{question_points}</span>
                          :
                           <span style={{color: 'red', fontWeight: 600}}>Incorrecto!</span>
                        }
                      </Typography>
                      :
                      <Typography variant="body2" color="textSecondary" component="p">
...

          {
            ...
            <h3 style={{color: 'white', fontWeight: 600, fontSize: '2em'}}>Solo preguntas de {this.props.location.filter}</h3>
            : null
          }
